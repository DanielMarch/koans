...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # you ask this like I haven't read perlre; it takes the most
  # characters it can while still having the whole pattern match.
  # quantifier followed by ? is non-greedy. followed by + is super-greedy
  # and won't give chars back to allow a match of the rest of the string.
